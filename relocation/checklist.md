...
## PHASE 1 — Pre-Departure California (Weeks 1–2)

### Legal: Exit the Lease
- [ ] 🔴 Serve written lease termination notice (certified mail — keep tracking number)
- [ ] Take timestamped video walkthrough of entire unit (every room, every wall, every fixture)
- [ ] Request pre-move-out inspection in writing from landlord (~2 weeks before vacate date)
- [ ] Create "unit condition" folder: save video + any move-in photos side by side
...
- [ ] 🔴 Purchase interim private health insurance — see `documents/health_insurance_comparison.md`
  - Must be active BEFORE you arrive in Canada
  - MSP wait: balance of arrival month + 2 full calendar months
  - If arriving May 15 → MSP active August 1
...
## PHASE 3 — Arrival & Border Crossing (Days 1–3)

> This phase is time-compressed. Do items in this order.
...
- [ ] Confirm interim health insurance is active and know how to use it
...
- [ ] Register at nearest StrongStart center — see `documents/childcare_action_sheet.md`
  - Bring: child's passport or birth certificate + lease agreement
  - Free drop-in; parent must accompany
  - Output: Personal Education Number (PEN) — your child's permanent BC academic ID
...
## PHASE 5 — Stabilization (Days 15–60+)
...
### Budget Tracking
- [ ] Set up monthly budget → use `templates/budget_tracker.md`
- [ ] Target: $15,000–$20,000 CAD liquid reserve through first 90 days
